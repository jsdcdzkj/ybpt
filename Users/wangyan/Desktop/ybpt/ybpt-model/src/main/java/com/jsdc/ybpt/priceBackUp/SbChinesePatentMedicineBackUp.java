 ...
 */
@Data
@Entity(name = "sbbf_chinese_patent_medicine")
@TableName("sbbf_chinese_patent_medicine")
public class SbChinesePatentMedicineBackUp extends Model<SbChinesePatentMedicineBackUp> {
    @TableId
    @Id
    private String id;
