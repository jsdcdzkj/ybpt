...
/**
 * 拨付通知-DRG(APPROP_NOTICE_DRG)数据库映射实体类
 *
 * @author wangxiao
 * @date 2024-05-17 15:32:03
 */
@Data
@TableName("APPROP_NOTICE_DRG")
public class AppropNoticeDrg {
    ...
    @TableField("ZGJJBFJE")
    //@ApiModelProperty(value = "本月职工医保基金拨付金额（万元）")
    @Alias("基金拨付金额")
    private BigDecimal zgjjbfje;

    @TableField("ZGBYZFLJ")
    //@ApiModelProperty(value = "本月职工医保不予支付累计（万元）")
    @Alias("不予支付累计")
    private BigDecimal zgbyzflj;

    @TableField("JMJJBFJE")
    //@ApiModelProperty(value = "本月居民医保基金拨付金额（万元）")
    @Alias("基金拨付金额")
    private BigDecimal jmjjbfje;

    @TableField("JMBYZFLJ")
    //@ApiModelProperty(value = "本月居民医保不予支付累计（万元）")
    @Alias("不予支付累计")
