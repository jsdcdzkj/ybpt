                        ...
                        <el-row :gutter="20">
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="护士姓名">
                                    <el-input placeholder="护士姓名" v-model.trim="queryForm.nurs_name" @keyup.enter.native="queryData"/>
                                </el-form-item>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="护士代码">
                                    <el-input placeholder="护士代码" v-model.trim="queryForm.nurs_code" @keyup.enter.native="queryData"/>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <vab-query-form>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card" shadow="never">
                    ...
                    >
                        ...
                        <el-table-column label="护士代码" prop="nurs_code" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="护士姓名" prop="nurs_name" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="人员编号" prop="psn_no" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="护士执业证书编号" prop="nurs_prac_cert_no" align="center" show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column label="护士技术职务" prop="nurs_pro_tech_duty_name" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="执业状态" prop="prac_stas" align="center" show-overflow-tooltip></el-table-column>
...
import {nursInfoB} from '@/api/query'
...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            ...
            const res = await nursInfoB(this.queryForm)
        ...
        resetForm() {
            this.queryForm.nurs_code = ''
            this.queryForm.nurs_name = ''
            this.queryData();
        },
    },
}
