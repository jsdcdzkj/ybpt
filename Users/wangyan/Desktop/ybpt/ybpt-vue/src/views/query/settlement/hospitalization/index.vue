    ...
    <div class="main-container">
        <el-row :gutter="20">
            ...
            <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
                <el-card class="card" shadow="never">
                    <div slot="header">
                        <span class="tips">住院费用重复数据查询</span>
                        <div class="right">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="身份证号码" prop="fixmedins_code"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="入院时间" prop="fixmedins_name"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="出院时间" prop="person_num"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="医疗费总额" prop="person_count"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="参保所属统筹区" prop="medfee_sumamt"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="支付地点类别" prop="pool_prop_selfpay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="结算人" prop="hifob_pay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="结算时间" prop="cvlserv_pay"
                                         show-overflow-tooltip></el-table-column>
...
import {hospitalization, hospitalizationExport} from '@/api/query'
    ...
    methods: {
        handleExport(row) {
            this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
                ...
                await hospitalizationExport(this.queryForm).then((res) => {
                    let fileName = "住院费用重复数据导出.xls";
        ...
        async getNatDataDicA() {
            ...
            const PSN_CERT_TYPE = await getNatDataDicA({'DIC_TYPE_CODE': 'PSN_CERT_TYPE'})
            this.PSN_CERT_TYPE_OPTIONS = PSN_CERT_TYPE.data
        },
        async getAdmdvs() {
        ...
        fetchData() {
            var that = this;
            that.loading = true;
            if (that.queryForm.begntime == null || that.queryForm.begntime == '') {
                that.$baseMessage('请输入开始日期!', 'error')
                return;
            }
            if (that.queryForm.endtime == null || that.queryForm.endtime == '') {
                that.$baseMessage('请输入开始日期!', 'error')
                return;
            }

            hospitalization(that.queryForm).then((res) => {
                if (res.code == 0) {
