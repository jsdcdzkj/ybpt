            ...
            <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="证件号码">
                  <el-input v-model.trim="queryForm.certno" placeholder="参保人员身份" @keyup.enter.native="queryData" />
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              ...
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="缴费类型">
                  <el-select v-model="queryForm.clct_type" placeholder="缴费类型" style="width: 100%" @change="queryData">
              ...
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                <el-form-item label="缴费时间">
                  <el-date-picker v-model.trim="queryForm.clct_time" type="date"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            <vab-query-form>
...
import Views from './components/view_resident'
import {getResidentPayinfo} from '@/api/personinfo'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await getResidentPayinfo(this.queryForm)
    ...
    reseat(){
      ...
      this.queryForm.clct_type = ''
      this.queryForm.clct_time = ''
      this.fetchData();
    },
  },
}
