...
import Views from './components/view_staff'
import {getStaffPayinfo} from '@/api/personinfo'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await getStaffPayinfo(this.queryForm)
