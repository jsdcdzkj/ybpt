        ...
        <el-card class="card" shadow="never">
          ...
          <el-form label-width="160px">
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="户口所在地医保区划">
                  <el-select v-model.trim="queryForm.resd_loc_admdvs" class="w" @change="queryData">
                    <el-option
...
import { reportInfo } from '@/api/settlementCenter.js'
export default {
  name: 'Index',
  ...
  methods: {
    ...
    moreQuery() {
     ...
     fetchData() {
      var that = this ;
       that.loading = true ;
       reportInfo(that.queryForm).then((res) => {
        if(res.code == 0){
    ...
    reseat(){
      ...
      this.queryForm.resd_loc_admdvs=""
