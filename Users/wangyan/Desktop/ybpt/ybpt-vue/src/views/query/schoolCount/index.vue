    ...
    <div class="main-container">
        <el-row :gutter="20">
                ...
                <el-card class="card" shadow="never">
                    ...
                    <el-form label-width="160px">
                        <el-row :gutter="20">
                            ...
                            <el-col :lg="8" :md="8" :sm="24" :xl="8" :xs="24">
                                <el-form-item label="缴费年度" prop="begntime">
                                    <el-date-picker
            ...
            <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
                <el-card class="card" shadow="never">
                    <div slot="header">
                        <span class="tips">学校缴费信息统计查询</span>
                        <div class="right">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="学校编号" prop="poolarea_no"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="学校名称" prop="fixmedins_code"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="缴费年度" prop="fixmedins_name"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="缴费人数合计" prop="person_num"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="基本医疗保险费" prop="person_count"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="照护险金额" prop="medfee_sumamt"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="基本医疗财政补助" prop="pool_prop_selfpay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="照护险财政补助" prop="hifob_pay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="医保统筹" prop="cvlserv_pay"
                                         show-overflow-tooltip></el-table-column>
...
import {schoolCount, schoolCountExport} from '@/api/query'
    ...
    methods: {
        handleExport(row) {
            this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
                ...
                await schoolCountExport(this.queryForm).then((res) => {
                    let fileName = "学校缴费信息统计导出.xls";
        ...
        fetchData() {
            var that = this;
            that.loading = true;
            schoolCount(that.queryForm).then((res) => {
                if (res.code == 0) {
