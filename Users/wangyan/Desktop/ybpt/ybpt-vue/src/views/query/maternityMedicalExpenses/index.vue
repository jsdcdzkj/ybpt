  ...
  <div class="main-container" >
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          <div slot="header">
            <span class="tips">生育医疗费受理情况</span>
          ...
          >
            ...
            <el-table-column
              show-overflow-tooltip
              prop="birthRegistrationCategory"
              label="生育登记类别"
              align="center"
              width="200px"
            ></el-table-column>
...
import { maternityMedicalExpensesData,maternityMedicalExpensesDataExport } from '@/api/query.js'
export default {
  name: 'Index',
  ...
  methods: {
    ...
    moreQuery() {
     ...
     fetchData() {
      var that = this ;
       that.loading = true ;
       maternityMedicalExpensesData(that.queryForm).then((res) => {
        if(res.code == 0){
    ...
    async handleExport() {
      this.$baseConfirm('确认导出吗？', null, async () => {
        ...
        const res = await maternityMedicalExpensesDataExport(this.queryForm);
        let fileName = "生育医疗费受理情况查询.xls";
