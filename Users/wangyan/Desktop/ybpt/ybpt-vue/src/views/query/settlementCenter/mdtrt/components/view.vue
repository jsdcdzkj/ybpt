              ...
              <el-row :gutter="20" v-if="isShow1">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="灵活就业标志">
                    <el-input
                            v-model.trim="queryForm.flxempe_flag"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="新生儿标志">
                    <el-input
                            v-model.trim="queryForm.nwb_flag"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="定点归属医保区划" class="custemitem">
                    <el-input
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="入院科室名称">
                    <el-input
                            v-model.trim="queryForm.adm_dept_name"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="出院科室名称">
                    <el-input
                            v-model.trim="queryForm.dscg_dept_name"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
