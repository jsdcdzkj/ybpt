        ...
        <el-card class="card" shadow="never">
          ...
          <el-form :model="queryForm" ref="queryForm" label-width="160px">
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="年度" prop="apply_year">
                  <el-date-picker
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          ...
          >
            ...
            <el-table-column label="流水号" prop="psn_clctstd_sn" align="center" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="年度" prop="year" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column label="经办人姓名" prop="opter_name" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column label="参保所属医保区划" prop="insu_admdvs_name" align="center" show-overflow-tooltip></el-table-column>
...
import {psnClctstdD} from '@/api/query'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await psnClctstdD(this.queryForm)
