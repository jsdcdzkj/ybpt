            ...
            <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
                <el-card class="card" shadow="never">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="业务名称" prop="poolarea_no"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="单位名称" prop="fixmedins_code"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="人数" prop="fixmedins_name"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="经办人" prop="person_num"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="经办时间" prop="person_count"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="复核人" prop="medfee_sumamt"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="复核时间" prop="pool_prop_selfpay"
                                         show-overflow-tooltip></el-table-column>
...
import {organization, organizationExport} from '@/api/query'
    ...
    methods: {
        handleExport(row) {
            this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
                ...
                await organizationExport(this.queryForm).then((res) => {
                    let fileName = "参保业务经办情况导出.xls";
        ...
        fetchData() {
            ...
            organization(that.queryForm).then((res) => {
                if (res.code == 0) {
