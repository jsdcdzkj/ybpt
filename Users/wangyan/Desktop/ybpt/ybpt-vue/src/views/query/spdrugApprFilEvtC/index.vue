  ...
  <div class="main-container">
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          <div slot="header">
            <span class="tips">特药审批备案事件记录</span>
          </div>
          <el-table
          ...
          >
            ...
            <el-table-column label="事件类型" prop="evt_type_name" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column label="申报来源" prop="dcla_souc_name" align="center" show-overflow-tooltip></el-table-column>
...
import {spdrugApprFilEvtC} from '@/api/query'
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const res = await spdrugApprFilEvtC(this.queryForm)
