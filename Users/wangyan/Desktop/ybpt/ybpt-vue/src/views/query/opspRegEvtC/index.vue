            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card" shadow="never">
                    ...
                    >
                        ...
                        <el-table-column label="病种类型" prop="dise_type_code_name" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="门慢门特病种目录代码" prop="opsp_dise_code" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="门慢门特病种名称" prop="opsp_dise_name" align="center" show-overflow-tooltip></el-table-column>
...
import {opspRegEvtC} from '@/api/query'
...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            ...
            const res = await opspRegEvtC(this.queryForm)
