  ...
  >
    <div class="drawer_content">
              ...
              <el-row :gutter="20" v-if="isShow1">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="转出地定点医药机构编号" class="custemitem">
                    <el-input v-model.trim="queryForm.username" @click.native="openwin"  disabled>
                      <el-button
                        slot="append"
                        icon="el-icon-search"
                        @click="openwin"
      ...
      <div class="drawer_footer">         
          <!-- <div class="left">          
          <el-form-item label="出院记录：" class="mb0">
            <el-image>
          ...
          <el-form-item label="检查报告：" class="mb0">
            <el-image>
              <div slot="error" class="image-slot">
                <i class="el-icon-picture-outline"></i>
              </div>
          ...
          <el-form-item label="门诊病例：" label-width="160px" class="mb0">
            <el-image>
              <div slot="error" class="image-slot">
                <i class="el-icon-picture-outline"></i>
              </div>
          ...
          <el-form-item label="评估申请表：" class="mb0" label-width="120px">
            <el-image>
              <div slot="error" class="image-slot">
                <i class="el-icon-picture-outline"></i>
              </div>
