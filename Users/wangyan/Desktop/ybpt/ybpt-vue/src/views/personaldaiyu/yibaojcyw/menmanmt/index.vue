<template>
    <div class="main-container" v-loading="loading" element-loading-text="数据同步中"
                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="医保电子凭证/身份证号">
                                    <el-input v-model.trim="queryForm.certno" placeholder="身份证号" clearable
                                        class="input-with-icon" @keyup.enter.native="selectByIdCards()">
                                    </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card" shadow="never">
                    ...
                    <el-table ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
                        highlight-current-row border @current-change="handleCurrentChange" height="420px">
                        <template slot="empty">
                        ...
                        <el-table-column show-overflow-tooltip label="审核状态" align="center" prop="approvalStatus"
                            width="120px" :formatter="statusFormat">
                        </el-table-column>
                        ...
                        <el-table-column show-overflow-tooltip prop="psn_cert_type" label="证件类型" align="center"
                            width="120px" :formatter="certFormat"></el-table-column>
                        ...
                        <el-table-column show-overflow-tooltip prop="insutypeName" label="参保险种" align="center"
                            width="120px"></el-table-column>
