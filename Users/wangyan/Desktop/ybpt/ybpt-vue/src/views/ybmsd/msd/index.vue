      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card tablecard" shadow="never">
          ...
          <el-table ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText" highlight-current-row
            ...
            <el-table-column show-overflow-tooltip label="机构名称" prop="emp_name" align="center" width="280px"></el-table-column>
            <el-table-column show-overflow-tooltip prop="emp_no" width="220px" label="机构编码" align="center">
            </el-table-column>
            <!--<el-table-column-->
            <!--show-overflow-tooltip-->
            <!--prop="emp_type"-->
            ...
            <!--&gt;</el-table-column>-->
            <el-table-column show-overflow-tooltip prop="admdvs" label="申请银行" align="center" >
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="emp_address" label="申请金额" align="center" width="200px"></el-table-column>
            <el-table-column show-overflow-tooltip prop="admdvs" label="状态" align="center" width="200px">
            </el-table-column>
            <!--<el-table-column-->
            <!--show-overflow-tooltip-->
            <!--prop="weixin"-->
