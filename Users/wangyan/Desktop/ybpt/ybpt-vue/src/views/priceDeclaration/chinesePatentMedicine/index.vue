			...
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				<el-card class="card" shadow="never">
					...
					<el-table v-loading="listLoading" ref="listTable" stripe :data="tableData"
						...
						<el-table-column show-overflow-tooltip prop="registeredName" label="注册名称" align="center" width="200px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="productName" label="商品名称" align="center" width="120px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="actualDosageForm" label="实际剂型" align="center" width="120px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="actualSpecification" label="实际规格" align="center" width="300px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="packagingMaterial" label="包装材质" align="center" width="250px"></el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="purchaseCeilingPrice" label="省集中采购上限价" align="center" width="150px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="paymentCriteria" label="医保支付标准" align="center" width="120px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="approvalNumber" label="批准文号" align="center" width="200px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="medicineEnterprise" label="药品企业" align="center" width="250px"></el-table-column>
						<el-table-column show-overflow-tooltip prop="limitPayment" label="医保限定支付范围" align="center" width="150px"></el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="nationalDrugCode" label="国家药品代码" align="center" width="200px"></el-table-column>
...
<script>
	...
	import {
		chinesePatentMedicineList,patentMedicineimportData,chinaExport
	} from '@/api/drug'
	export default {
		name: 'drugsManage',
		components: {
		...
		methods: {
			...
			handleAdd2() {
				this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
					this.loading = true
					await chinaExport(this.form).then((res) => {
						let fileName = "中成药数据导出.xlsx";
