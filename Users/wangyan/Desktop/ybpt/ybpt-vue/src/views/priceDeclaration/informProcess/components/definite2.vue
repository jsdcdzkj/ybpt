...
<!--            <el-input v-model="form.sbMedicalCalculate.org_price" type="number" min="0" placeholder="请输入"-->
<!--                      autocomplete="off"></el-input>-->
<!--          </el-form-item>-->
<!--        </el-col>-->

        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
          <el-form-item label="本市公立医疗机构价格：" class="custemitem">
        ...
        <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
          <el-form-item label="外地同级医院参考价格:" prop="sbMedicalCalculate.reference_price" class="custemitem">
            <el-input v-model="form.sbMedicalCalculate.reference_price" type="number" min="0" placeholder="请输入"
                      autocomplete="off"></el-input>
          </el-form-item>
        </el-col>
<!--        <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">-->
<!--          <el-form-item label="拟定价" prop="sbMedicalCalculate.protocol_price">-->
<!--            <el-input v-model="form.sbMedicalCalculate.protocol_price" type="number" min="0" placeholder="请输入"-->
<!--                      autocomplete="off"></el-input>-->
<!--          </el-form-item>-->
<!--        </el-col>-->
        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
          <el-form-item label="拟定价:">
        ...
        >
          ...
          <el-table-column label="操作" align="center" width="140">
            <template slot-scope="scope">
              ...
              <el-button @click="handleClick(scope.row)" type="text" v-if="scope.row.isEdit==false" size="mini">编辑
              </el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <div class="box_card mt2">
        ...
        <el-table ref="tb" :data="form.sbMaterialsConsumption"
          ...
          <el-table-column prop="quantity" align="center" :required="true" label="数量">
            <template slot-scope="{row,$index}">
              ...
              <el-input v-if="showEdit[$index]" v-model="form.sbMaterialsConsumption[row.xh-1].quantity" type="number"
          ...
          <el-table-column prop="price" align="center" :required="true" label="单价（元）">
            <template slot-scope="{row,$index}">
              ...
              <el-input v-if="showEdit[$index]" v-model="form.sbMaterialsConsumption[row.xh-1].price" type="number"
                        min="0" placeholder="请输入">
              </el-input>
            </template>
          </el-table-column>
        ...
        <el-table ref="tb2" :data="form.sbFixedAssets"
          ...
          <el-table-column prop="name" align="center" :required="true" label="设备名称">
            <template slot-scope="{row,$index}">
              ...
              <el-input v-if="showEditG[$index] && row.name != '小计'" v-model="form.sbFixedAssets[row.xh-1].name"
                        placeholder="请输入">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="price" align="center" :required="true" label="原值（元）">
            <template slot-scope="{row,$index}">
              ...
              <el-input v-if="showEditG[$index]" v-model="form.sbFixedAssets[row.xh-1].price" type="number" min="0"
                        placeholder="请输入">
              </el-input>
            </template>
          </el-table-column>
          <el-table-column prop="year" align="center" :required="true" label="使用年限（年）">
            <template slot-scope="{row,$index}">
              ...
              <el-input v-if="showEditG[$index]" v-model="form.sbFixedAssets[row.xh-1].year" type="number" min="0"
                        placeholder="请输入">
              </el-input>
            </template>
          </el-table-column>
      ...
      <div class="box_card mt2">
        ...
        <el-table ref="listTable4" :data="tableData4"
                  ...
                  highlight-current-row
                  border
                  :show-header="false" @input="managePrice()">
          ...
          <el-table-column label="操作" align="center" width="140">
            <template slot-scope="scope">
              ...
              <el-button @click="handleClick(scope.row)" type="text" v-if="scope.row.isEdit==false && scope.row.aaa1 != '小计'" size="mini">编辑
              </el-button>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-row :gutter="20">
          <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
            <el-form-item label="项目成本合计" prop="sbMedicalCalculate.project_total">
              <el-input v-model="form.sbMedicalCalculate.project_total" type="number" min="0" placeholder=""
  ...
  methods: {
    showDia(row) {
      ...
      if (row.sbFixedAssets) {
        ...
        this.$set(this.showEditG, 0, false)
    ...
    handleDeleteBtn(index, row) {
      ...
      this.$confirm('请是否确认删除该属性?', '提示', {
        ...
        callback: (action) => {
          if (action === 'confirm') {
            if (this.form.sbMaterialsConsumption.length > 2) {
