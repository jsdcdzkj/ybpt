...
<!--&lt;!&ndash;          <el-radio :label="1" v-show="fixmedinsB.biznet == 1 || fixmedinsB.biznet == 2">药品</el-radio>&ndash;&gt;-->
<!--          &lt;!&ndash;          <el-radio :label="2">耗材</el-radio>&ndash;&gt;-->
<!--        </el-radio-group>-->
<!--      </el-form-item>-->
...
<!--&lt;!&ndash;      <el-form-item label="药品类型" prop="drugs" v-if="form.resource==1">&ndash;&gt;-->
<!--&lt;!&ndash;        <el-radio-group v-model="form.drugs" class="drugs-type">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-radio :label="1">西药</el-radio>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-radio :label="2">中成药</el-radio>&ndash;&gt;-->
    ...
    async save() {
      ...
      //   if (valid) {
          ...
          const row = {
            ...
            orgName: this.userinfo.org_name,
            // aggrementLv: this.fixmedinsB.aggrement_lv,
