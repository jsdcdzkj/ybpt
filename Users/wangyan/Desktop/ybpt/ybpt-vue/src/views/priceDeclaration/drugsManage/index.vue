			...
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				<el-card class="card" shadow="never">
					...
					<el-table v-loading="listLoading" ref="listTable" stripe :data="tableData"
						...
						<el-table-column show-overflow-tooltip prop="common_name_code" label="药品通用名编码" align="center" fixed="left" width="180px">
					    </el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="dosageForm" label="医保剂型" align="center" width="120px"></el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="medicineEnterprise" label="药品企业" align="center" width="200px"></el-table-column>
						...
						<el-table-column show-overflow-tooltip prop="nationalDrugCode" label="国家药品代码" align="center" width="230px"></el-table-column>
...
<script>
	...
	import {
		selectList,importData,westExport
	} from '@/api/drug'
	export default {
		name: 'drugsManage',
		components: {
		...
		methods: {
			...
			handleAdd2() {
				this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
					this.loading = true
					await westExport(this.form).then((res) => {
						let fileName = "西药数据导出.xlsx";
			...
			async fetchData() {
				...
				selectList(this.queryForm).then((res) => {
					if (res.code == 0) {
