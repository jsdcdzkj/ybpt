  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-form-item label="项目编码">
        <el-input v-model.trim="form.project_code" placeholder="请选择" @click.native="openwin(form)" readonly>
          <el-button
              slot="append"
              icon="el-icon-search"
              @click="openwin"
...
<!--        </el-select>-->
        <el-input v-model="form.declare_type" placeholder="请输入" autocomplete="off" readonly></el-input>
      </el-form-item>
      ...
      <el-form-item label="项目执行科室" prop="departments">
        <el-input v-model="form.departments" placeholder="请输入" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="本市同级公立医疗机构价格" prop="org_price" class="custemitem">
        <el-input v-model.trim="form.org_price" placeholder="请输入" type="number" autocomplete="off" min="0" readonly></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        'declare_type': [{required: true, trigger: 'blur', message: '请选择申报类型'}],
