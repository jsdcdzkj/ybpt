          ...
          >
            ...
            >
              <template #default="{ row }">
                ...
                <el-button plain @click="dow(row)" type="primary" size="mini">
                  下载文件
                </el-button>
              </template>
            </el-table-column>
...
<script>
  import { fileDeliveryList, importData } from '@/api/noticeDelivery.js'
