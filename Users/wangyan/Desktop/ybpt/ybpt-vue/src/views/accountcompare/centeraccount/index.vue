            ...
            <el-row :gutter="20">
              ...
              <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="4">
                <el-form-item label="对账状态">
                  <el-select v-model="queryForm.check_status" style="width: 100%">
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          ...
          <el-table v-loading="listLoading" ref="listTable" stripe :data="list"
            ...
            <el-table-column show-overflow-tooltip prop="settle_date" label="结算日期" align="center" width="120px">
            </el-table-column>
            ...
            <el-table-column show-overflow-tooltip prop="hifdm_pay" label="伤残军人医疗保障基金" align="center" width="170px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="hifmi_pay" label="大病补充医疗保险基金" align="center" width="200px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="hifes_pay" label="补充医疗保险基金" align="center" width="200px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="acct_mulaid_pay" align="center" label="账户共济支付金额" width="200px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="maf_pay" align="center" label="医疗救助基金" width="120px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="othfund_pay" align="center" label="倾斜救助基金" width="110px">
            </el-table-column>
...
import { getList,dayListExcel } from '@/api/reconciliation'
export default {
  name: 'Index',
  components: {},
  data() {
  ...
  methods: {
    ...
    async excelDetails() {
          this.$baseConfirm('确认导出吗？', null, async () => {
            this.listLoading = true
            const res = await dayListExcel(this.queryForm);
            let fileName = "日对账信息.xls";
