  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      <el-row :gutter="20">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-form-item label="告知手续名称" prop="notificationProcedureName" class="custemitem">
            <el-input
                    v-model.trim="form.notificationProcedureName"
                    autocomplete="off"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-form-item label="单位编码" prop="emp_no" >
            <el-input
                    :disabled="isDisabled"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        notificationProcedureName: [
          { required: true, trigger: 'blur', message: '请输入告知手续名称名称' },
        ],
