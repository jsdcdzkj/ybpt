      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          ...
          <el-form label-width="100px">
            <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6" v-if="isShow">
                <el-form-item label="是否预约">
                  <el-select
                    v-model="queryForm.isyy"
                    class="w"
              ...
              <!--<el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6" v-if="querryShow">-->
              <!--<el-form-item label="预约时间">-->
              <!--<el-date-picker v-model.trim="queryForm.apply_date" type="date" format="yyyy-MM-dd"-->
              ...
              <!--<el-input v-model.trim="queryForm.org_name" />-->
              <!--</el-form-item>-->
              <!--</el-col>-->
              <!--<el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">-->
              <!--<el-form-item label="套餐">-->
              <!--<el-input v-model.trim="queryForm.pack_name" />-->
              <!--</el-form-item>-->
              <!--</el-col>-->
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              ...
              >
                <el-form-item label="体检进度">
                  <el-select
                    v-model="queryForm.sched"
                    clearable
                    class="w"
                    @change="isshowtime"
                  >
                    <el-option label="待体检" value="0"></el-option>
                    <el-option label="已体检" value="1"></el-option>
                    <el-option label="已过期" value="2"></el-option>
                    <el-option label="已上传报告" value="3"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
              ...
              <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6" v-if="showtime">
    ...
    methods: {
      ...
      handleBackOut(row) {
        this.$baseConfirm('你确定要撤销吗', null, async () => {
          ...
          const { code, msg } = await backOutByAdmin(object)
          if (code === 0) {
            this.$baseMessage(msg, 'success')
            this.fetchData()
          } else if (code === 1) {
