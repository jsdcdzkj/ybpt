      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          ...
          <el-table v-loading="listLoading" ref="listTable" stripe :data="list"
            ...
            <el-table-column show-overflow-tooltip label="年份" align="left" prop="username"></el-table-column>
            <el-table-column show-overflow-tooltip prop="truename" width="200px" label="预约限制次数" align="center">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="bumen" label="修改限制次数" align="center" width="200px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="phone" label="创建时间" align="center" width="120px">
            </el-table-column>
