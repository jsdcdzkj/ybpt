...
export function sbApplyList(data) {
    return request({
        url: '/notifyApply/selectPreparationNotificationReviewList',
        method: 'post',
        data,
    })
}
...
export function sbApplyExport(data) {
    return request({
        url: '/notifyApply/notifyApplyExport',
        method: 'post',
        responseType: "blob",
        headers: {
            'Content-Type': 'application/x-download'
...
export function accAcceptanceLetter(data) {
    return request({
        url: '/notifyApply/viewPdf?id='+data,
        method: 'post',
    })
}
