...
<body>
    <div class="wrap">
        <header class="header blue-back" id="header">
            <div class="topbar">
        ...
        <div class="contWrap">
            ...
            <div class="tabs-content">
                <ul class="tab-box orderlist active">
                    <li>
                        <div class="row1">
                        ...
                        <div class="row4">                               
                            <div class="btns jiaofei" onclick="pingjia()">去评价</div>                          
                        </div>
                    </li>
                    <li>
                        <div class="row1">
        ...
        <footer class="menu_bar block menu_bar_ticket" id="footer">
            ...
            <div id="rebate" class="menu-tab-item on">
