        ...
        <el-card class="card" shadow="never">
          ...
          <el-form label-width="160px">
            <el-row :gutter="20">
              ...
              <el-form-item label="医疗服务项目名称">
              <el-input
              v-model.trim="queryForm.servitem_name"
              placeholder="医疗服务项目名称"
...
import { medicalServiceData,medicalServiceDataExport } from '@/api/query.js'
export default {
  name: 'Index',
  ...
  methods: {
    ...
    moreQuery() {
     ...
     fetchData() {
      var that = this ;
       that.loading = true ;
       medicalServiceData(that.queryForm).then((res) => {
        if(res.code == 0){
    ...
    async handleExport() {
      this.$baseConfirm('确认导出吗？', null, async () => {
        ...
        const res = await medicalServiceDataExport(this.queryForm);
        let fileName = "医疗服务项目信息查询.xls";
