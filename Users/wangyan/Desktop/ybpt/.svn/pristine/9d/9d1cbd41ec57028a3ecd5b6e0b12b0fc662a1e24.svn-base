...
<script>
  import { updateFileDelivery } from '@/api/noticeDelivery.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        admdvs: [],
        rules: {
          user_type: [{ required: true, trigger: 'blur', message: '请输入' }],
          fixmedins_code: [
            { required: true, trigger: 'submit', message: '请输入' },
          ],
        },
        title: '',
