          ...
          <div class="box_card">
            ...
            <div class="box_content">
              <el-row :gutter="20" v-if="isShow1">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="结算时间" class="custemitem">
                    <el-input
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="结算类别" class="custemitem">
                    <el-input
                            v-model.trim="queryForm.setl_type"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="医疗费总额" class="medfee_sumamt">
                    <el-input
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="统筹基金支出">
                    <el-input
                            v-model.trim="queryForm.hifp_pay"
                            disabled
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="公务员医疗补助资金支出" class="custemitem">
                    <el-input
                            v-model.trim="queryForm.cvlserv_pay"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="补充医疗保险基金支出" class="custemitem">
                    <el-input
                            v-model.trim="queryForm.hifes_pay"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="其它基金支付" class="custemitem">
                    <el-input
                            v-model.trim="queryForm.othfund_pay"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="现金支付金额" class="custemitem">
                    <el-input
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="自费中医院负担部分" class="custemitem">
                    <el-input
                            v-model.trim="queryForm.ownpay_hosp_part"
                            disabled
                    ></el-input>
                  </el-form-item>
                </el-col>
