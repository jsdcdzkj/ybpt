              ...
              <el-row :gutter="20" v-if="isShow">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="农民工标志">
                    <el-input
                            v-model.trim="queryForm.peawkr_flag"
                            disabled
                    />
                  </el-form-item>
                </el-col>
          ...
          <div class="box_card">
            ...
            <div class="box_content">
              <el-row :gutter="20" v-if="isShow1">
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="单位缴费基数">
                    <el-input v-model.trim="queryForm.emp_clctstd" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="人员缴费基数" >
                    <el-input v-model.trim="queryForm.psn_clctstd" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="工资">
                    <el-input v-model.trim="queryForm.wag" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="单位缴费比例或定额标准" class="custemitem">
                    <el-input v-model.trim="queryForm.emp_clct_paraval" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="单位缴费划入个人账户比例或定额标准" class="custemitem">
                    <el-input v-model.trim="queryForm.emp_into_paraval" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="单位缴费金额">
                    <el-input v-model.trim="queryForm.emp_clct_amt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="个人缴费比例或定额标准" class="custemitem">
                    <el-input v-model.trim="queryForm.psn_clct_paraval" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="个人缴费划入个人账户比例或定额标准" class="custemitem">
                    <el-input v-model.trim="queryForm.psn_into_paraval" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="个人缴费划入个人账户金额" class="custemitem">
                    <el-input v-model.trim="queryForm.psn_clct_into_acct_amt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="其他缴费划拨金额" class="custemitem">
                    <el-input v-model.trim="queryForm.oth_clct_traf_amt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="财政补助划拨金额" class="custemitem">
                    <el-input v-model.trim="queryForm.finsubs_traf_amt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="划拨总金额" >
                    <el-input v-model.trim="queryForm.traf_sumamt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="利息" class="inte">
                    <el-input v-model.trim="queryForm.finsubs_traf_amt" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="滞纳金">
                    <el-input v-model.trim="queryForm.latefee" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              ...
              <el-row :gutter="20">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                  <el-form-item label="划拨时间">
                    <el-input v-model.trim="queryForm.traf_time" disabled />
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
