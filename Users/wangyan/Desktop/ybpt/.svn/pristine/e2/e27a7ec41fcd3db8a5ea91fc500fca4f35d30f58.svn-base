            ...
            <el-row :gutter="20">
              ...
              <el-col v-if="isAdmin" :lg="6" :md="6" :sm="24" :xl="6" :xs="24">
                <el-form-item label="项目名称">
                  <el-input
                    v-model.trim="queryForm.project_name"
                    placeholder="请输入"
                    @keyup.enter.native="queryData"
                  />
                </el-form-item>
              ...
              <el-col v-if="isAdmin" :lg="6" :md="6" :sm="24" :xl="6" :xs="24">
                <el-form-item label="项目编码">
                  <el-input
                    v-model.trim="queryForm.project_code"
                    placeholder="请输入"
                    @keyup.enter.native="queryData"
                  />
                </el-form-item>
              ...
              <el-col v-if="isAdmin" :lg="6" :md="6" :sm="24" :xl="6" :xs="24">
                <el-form-item label="医疗服务">
                  ...
                  >
                    ...
                    ></el-option>
                    <el-option
                      label="非公立营利性自设项目自主定价"
                      value="营利性"
                    ></el-option>
                    <el-option
                      label="公立医疗机构医疗服务项目自主定价"
                      value="政府非营利"
                    ></el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col v-if="isAdmin" :lg="6" :md="6" :sm="24" :xl="6" :xs="24">
                <el-form-item label="创建时间">
                  ...
                  <!--                                  v-model="queryForm.createTime"></el-date-picker>-->
                  <el-date-picker
          ...
          >
            ...
            >
              <template #default="{ row }">
                ...
                <el-button
                  v-if="
                    roles.indexOf('examine-second') > -1 &&
                    row.status == '1' &&
                    row.isAudit == 'true'
                  "
                  plain
                ...
                <el-button
                  ...
                  size="mini"
                  type="primary"
                  @click="handleLookStateHospital(row, '1')"
                >
                  查看
                </el-button>
                ...
                <el-button
                  v-if="row.status == '4' && row.user_type != '非定点'"
                  plain
                  size="mini"
                  type="primary"
