                        ...
                        <el-row :gutter="20">
                            ...
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="读取状态">
                                    <el-select v-model="queryForm.is_read" style="width: 100%" clearable>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card tablecard" shadow="never">
                    ...
                    <el-table ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText"
                        ...
                        <el-table-column show-overflow-tooltip label="通知名称" prop="title" align="center"></el-table-column>
...
<!--                        </el-table-column>-->
                        ...
                        <!--                            align="center"></el-table-column>-->
<!--                        <el-table-column show-overflow-tooltip prop="range" label="通知范围" width="260px"-->
<!--                                         align="center"></el-table-column>-->
                        <el-table-column show-overflow-tooltip prop="is_read" label="读取状态" width="120px"
                                         align="center">
                            <template v-slot="{ row }">
                                <span :style="{color: row.is_read == '1' ? '#13ce66' : '#ff4d4f'}">{{ row.is_read == '1' ? '已读' : '未读' }}</span>
                            </template>
                        </el-table-column>
...
<!--                            </template>-->
<!--                        </el-table-column>-->
                        <el-table-column show-overflow-tooltip label="操作" width="450" align="center" fixed="right">
                            <template #default="{ row }">
<!--                                    <el-button plain @click="publics(row)" v-if="row.is_launch == 0 && isShowEdit" type="success"-->
<!--                                               size="mini">发布-->
<!--                                    </el-button>-->
<!--                                    <el-button plain @click="handleEdit(row)" v-if="row.is_launch == 0 && isShowEdit"  type="primary"-->
<!--                                               size="mini">编辑-->
<!--                                    </el-button>-->
<!--                                    <el-button plain @click="handleDelete(row)" v-if="row.is_launch == 0 && isShowEdit" type="danger"-->
<!--                                               size="mini">删除-->
<!--                                    </el-button>-->
<!--                                    <el-button plain @click="handleCancel(row)" v-if="row.is_launch == 1 && isShowEdit" type="danger"-->
<!--                                               size="mini">撤销-->
<!--                                    </el-button>-->
...
import {deleteById, selectPageList, getPageListForAccepter} from "@/api_check/notice";
...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            ...
            const {data} = await getPageListForAccepter(this.queryForm)
        ...
        handleCancel(row) {
            this.$baseConfirm('你确定要撤消发布吗', null, async () => {
                this.$baseMessage('撤消发布成功', 'success')
