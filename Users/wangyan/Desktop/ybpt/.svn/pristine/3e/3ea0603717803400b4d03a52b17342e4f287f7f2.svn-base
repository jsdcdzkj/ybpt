        ...
        <div class="drawer_main">
          ...
          <div class="box_card base-info">
            ...
            >
              ...
              <el-table-column align="center" label="申报类型" prop="declare_type" show-overflow-tooltip>
              </el-table-column>
              ...
              <el-table-column align="center" label="项目执行科室" min-width="120" prop="departments" show-overflow-tooltip>
              </el-table-column>
