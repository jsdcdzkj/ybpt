                ...
                <el-card class="card" shadow="never">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="身份证号" prop="fixmedins_code"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="单位名称" prop="fixmedins_name"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="险种类型" prop="person_num"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="变更类型" prop="person_count"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="变更原因" prop="medfee_sumamt"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="变更日期" prop="pool_prop_selfpay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="经办人" prop="hifob_pay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="经办时间" prop="cvlserv_pay"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="备注" prop="acct_pay"
                                         show-overflow-tooltip></el-table-column>
...
import {personal, personalExport} from '@/api/query'
    ...
    methods: {
        handleExport(row) {
            this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
                ...
                await personalExport(this.queryForm).then((res) => {
                    let fileName = "个人变更信息导出.xls";
        ...
        fetchData() {
            ...
            personal(that.queryForm).then((res) => {
                if (res.code == 0) {
