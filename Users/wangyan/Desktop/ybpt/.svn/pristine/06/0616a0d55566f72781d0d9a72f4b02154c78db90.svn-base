                        ...
                        <el-row :gutter="20">
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="药师姓名">
                                    <el-input placeholder="药师姓名" v-model.trim="queryForm.phar_name" @keyup.enter.native="queryData"/>
                                </el-form-item>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                                <el-form-item label="药师代码">
                                    <el-input placeholder="药师代码" v-model.trim="queryForm.phar_code" @keyup.enter.native="queryData"/>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <vab-query-form>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card" shadow="never">
                    ...
                    >
                        ...
                        <el-table-column label="药师姓名" prop="phar_name" align="center" show-overflow-tooltip></el-table-column>
                        <el-table-column label="药师代码" prop="phar_code" align="center" show-overflow-tooltip></el-table-column>
...
import {pharInfoB} from '@/api/query'
...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            ...
            const res = await pharInfoB(this.queryForm)
