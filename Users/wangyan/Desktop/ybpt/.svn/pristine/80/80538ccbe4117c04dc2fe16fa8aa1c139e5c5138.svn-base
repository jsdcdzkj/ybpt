...
<!--              <div class="box">-->
<!--                <p class="box_left">甲方机构名称：徐州市医疗保障局</p>-->
<!--                <p class="box_right">地址：徐州市医疗保障局</p>-->
<!--              </div>-->
<!--              <div class="box">-->
<!--                <p class="box_left">乙方国家机构名称：XXXXXXX</p>-->
<!--                <p class="box_right">乙方国家医保编码：XXXXXXX</p>-->
<!--                <p class="box_right">乙方地址：XXXXXXX</p>-->
<!--              </div>-->
<!--            </div>-->
...
import {getOneInfo} from "@/api_net/tagAgreement";
