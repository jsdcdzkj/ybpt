            ...
            <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="业务申请类型">
                  <el-select v-model="queryForm.biz_appy_type" placeholder="业务申请类型" style="width: 100%"
                    @change="queryData">
                    <el-option v-for="item in insutypeList" :key="item.nat_dic_val_code" :label="item.nat_dic_val_name"
              ...
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="定点医药机构编号">
                  <el-input v-model.trim="queryForm.fixmedins_code" placeholder="定点医药机构编号" @keyup.enter.native="queryData" />
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              ...
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="姓名">
                  <el-input v-model.trim="queryForm.psn_name" placeholder="姓名" @keyup.enter.native="queryData" />
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                <el-form-item label="电子凭证号">
                  <el-input v-model.trim="queryForm.hsecfc" placeholder="电子凭证号" @keyup.enter.native="queryData" />
                </el-form-item>
              </el-col>
              <!--<el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">-->
      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card" shadow="never">
          ...
          <el-table ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText" highlight-current-row
            border @current-change="handleCurrentChange" height="420px" v-loading="loading">
            <template slot="empty">
            ...
            <el-table-column show-overflow-tooltip label="电子凭证号" align="center" prop="hsecfc" width="120px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="certno" width="180px" label="证件号码" align="center">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="fixmedins_code" label="定点医药机构编号" align="center" width="120px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="fixmedins_name" label="定点医药机构名称" align="center" width="220px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="biz_appy_type_name" label="业务申请类型" align="center"
              width="200px"></el-table-column>
            <el-table-column show-overflow-tooltip prop="begndate" label="开始日期" align="center" width="180px"
              format="yyyy-MM-dd" value-format="yyyy-MM-dd" :formatter="formatDate"></el-table-column>
            <el-table-column show-overflow-tooltip prop="enddate" label="结束日期" align="center" width="120px"
              format="yyyy-MM-dd" value-format="yyyy-MM-dd" :formatter="formatDate"></el-table-column>
            <el-table-column show-overflow-tooltip prop="poolarea_no" align="center" label="统筹区编号"></el-table-column>
...
import { selectPsnList } from '@/api/settlementCenter.js'
  ...
  methods: {
    ...
    moreQuery() {
     ...
     fetchData() {
      var that = this ;
       that.loading = true ;
      selectPsnList(that.queryForm).then((res) => {
        if(res.code == 0){
          that.loading = false;
