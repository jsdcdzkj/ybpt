 ...
 */
@Data
@Entity(name = "sbbf_non_medical_insurance")
@TableName("sbbf_non_medical_insurance")
public class SbNonMedicalInsuranceBackUp extends Model<SbNonMedicalInsuranceBackUp> {
    @TableId
    @Id
    private String id;
