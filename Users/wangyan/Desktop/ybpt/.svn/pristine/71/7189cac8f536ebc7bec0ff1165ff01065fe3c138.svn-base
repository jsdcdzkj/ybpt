          ...
          <div class="box_card">
            ...
            <div class="box_content">
              <el-row :gutter="20">
                ...
                <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                  <el-form-item label="登记病种代码" prop="password">
                    <el-input
          ...
          <div class="box_card">
            ...
            <div class="box_content">
              <el-row :gutter="20">
                ...
                <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                  <el-form-item label="互斥病种代码" prop="dise_mutex_code">
                    <el-input
...
export default {
  ...
  data() {
    return {
      ...
      insuTypes:[],
      rules: {
        dise_name: [{required: true, trigger: 'submit', message: '请输入正确的信息'}],
        dise_mutex_name: [{required: true, trigger: 'submit', message: '请输入正确的信息'}],
