 ...
 */
@Data
@Entity(name = "org_reconciliation_month")
@TableName("org_reconciliation_month")
public class OrgReconciliationMonth extends Model {
    @TableId
    @Id
    ...
    private String hifob_pay;           //大额医疗补助基金
...
//    private String hifdm_pay;           //伤残军人医疗保障基金
    ...
    private String check_time;          //对账时间
    private String check_status;        //对账结果  0：未对账 1：对账通过 2：对账不通过
    private String result_msg;          //对账结果说明
    private String BizId;               //对账结果外键
