    ...
    <div class="main-container">
        <el-row :gutter="20">
                        ...
                        <el-row :gutter="20">
                            <el-col :lg="8" :md="8" :sm="24" :xl="8" :xs="24">
                                <el-form-item label="定点医药机构代码">
                                    <el-input v-model.trim="queryForm.fixmedins_code" placeholder="定点医药机构代码"
                            ...
                            <el-col :lg="8" :md="8" :sm="24" :xl="8" :xs="24">
                                <el-form-item label="协议名称">
                                    <el-input v-model.trim="queryForm.medins_name" placeholder="协议名称"
                                              @keyup.enter.native="queryData"/>
                                </el-form-item>
                            </el-col>
                            <el-col :lg="8" :md="8" :sm="24" :xl="8" :xs="24">
                                <el-form-item label="签订协议年度" prop="begntime">
                                    <el-date-picker
            ...
            <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
                <el-card class="card" shadow="never">
                    <div slot="header">
                        <span class="tips">定点医药机构协议信息</span>
                        <div class="right">
                    ...
                    >
                        ...
                        <el-table-column align="center" label="定点归属医保区划" prop="fix_blng_admdvs"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="协议类型" prop="fix_cntr_type"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="协议名称" prop="fix_cntr_name"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="签订协议年度" prop="cntr_sign_year"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="开始时间" prop="begntime"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="结束时间" prop="endtime"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="有效标志" prop="vali_flag"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column align="center" label="备注" prop="memo" show-overflow-tooltip></el-table-column>
...
import {fixmedinsCntrRegD, fixmedinsCntrRegDExcel} from '@/api/query'
    ...
    methods: {
        handleExport(row) {
            this.$baseConfirm('你确定要导出当前信息吗', null, async () => {
                ...
                await fixmedinsCntrRegDExcel(this.queryForm).then((res) => {
                    let fileName = "定点医药机构协议信息导出.xls";
        ...
        fetchData() {
            var that = this;
            that.loading = true;
            fixmedinsCntrRegD(that.queryForm).then((res) => {
                if (res.code == 0) {
