                ...
                <el-card class="card" shadow="never">
                    ...
                    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                        <el-row :gutter="20">
                            ...
                            <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="4">
                                <el-form-item label="伤残军人医疗保障基金" class="custemitem" prop="hifdm_pay">
                                    <el-input v-model.trim="form.hifdm_pay" />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="4">
                            ...
                            <el-col :xs="24" :sm="24" :md="8" :lg="4" :xl="4">
                                <el-form-item label="倾斜救助基金" prop="othfund_pay">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-card class="card" shadow="never">
                    ...
                    <el-table v-loading="listLoading" ref="listTable" stripe :data="list"
                        ...
                        <el-table-column show-overflow-tooltip prop="acct_mulaid_pay" label="账户共济支付金额" align="center"
                        ...
                        <el-table-column show-overflow-tooltip prop="hifes_pay" label="补充医疗保险基金" align="center"
                            width="200px"></el-table-column>
                        <el-table-column show-overflow-tooltip prop="hifdm_pay" align="center" label="伤残军人医疗保障基金"
                            width="200px"></el-table-column>
                        <el-table-column show-overflow-tooltip prop="maf_pay" align="center" label="医疗救助基金"
                            width="200px"></el-table-column>
                        <el-table-column show-overflow-tooltip prop="othfund_pay" align="center" label="倾斜救助基金"
                            width="200px"></el-table-column>
                        ...
                        <el-table-column show-overflow-tooltip label="对账结果" width="120" align="center" fixed="right">
...
import { checkReconciliation, dayDetailsExcel, genNewReconciliation, getList } from '@/api/reconciliation'
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                hifdm_pay: [{ required: true, trigger: 'blur', message: '请输入伤残军人医疗保障基金' }],
                ...
                othfund_pay: [{ required: true, trigger: 'blur', message: '请输入倾斜救助基金' }],
    ...
    methods: {
        ...
        async excelDetails(orgId) {
            ...
            const res = await dayDetailsExcel({ "orgReconciliationId": orgId });
            let fileName = "日对账明细.xls";
        ...
        async genNewRecord(orgId) {
            ...
            var that = this;
            this.listLoading = true
            const res = await genNewReconciliation({ "orgReconciliationId": orgId });
            if (res.code == "0") {
                setTimeout(() => {
        ...
        async reconciliation() {
            ...
            this.$refs['form'].validate(async (valid) => {
                if (valid) {
                    const res = await checkReconciliation(this.form);
                    if (res.code == "0") {
        ...
        //获取统筹区
        async getAdmdvs(type) {
            if (type == '3' || type == '4') {
                const res = await getDicts({ "type": "ADMDVS_YD" });
                if (res.code == "0") {
