      ...
      <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
        <el-card class="card" shadow="never">
          ...
          >
            ...
            <el-table-column align="center" label="定点医疗机构编码" prop="fixmedins_code"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="定点医疗机构名称" prop="fixmedins_name"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="就诊人次" prop="person_num"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="就诊人数" prop="person_count"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="医疗总费用" prop="medfee_sumamt"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="基本医疗基金支出" prop="pool_prop_selfpay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="大额医疗补助基金支出" prop="hifob_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="公务员医疗补助基金支出" prop="cvlserv_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="个人账户支出" prop="acct_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="个人现金支出" prop="cash_payamt"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="自费中医院承担部分" prop="ownpay_hosp_part"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="补充医疗保险基金支出" prop="hifes_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="大病保险基金支出" prop="hifmi_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="医疗救助基金支出" prop="maf_pay"
                             show-overflow-tooltip></el-table-column>
            <el-table-column align="center" label="伤残人员医疗保障基金支出" prop="hifdm_pay"
                             show-overflow-tooltip></el-table-column>
