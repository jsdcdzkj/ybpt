      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="card tablecard" shadow="never">
          ...
          <el-table ref="listTable" stripe :data="list" :element-loading-text="elementLoadingText" highlight-current-row
            ...
            <el-table-column show-overflow-tooltip label="单位名称" prop="emp_name" align="center" width="280px"></el-table-column>
            <el-table-column show-overflow-tooltip prop="emp_no" width="220px" label="单位编码" align="center">
            </el-table-column>
            <!--<el-table-column-->
            <!--show-overflow-tooltip-->
            <!--prop="emp_type"-->
            ...
            <!--&gt;</el-table-column>-->
            <el-table-column show-overflow-tooltip prop="admdvs" label="行政区划" align="center" width="120px"></el-table-column>
            <el-table-column show-overflow-tooltip prop="notificationProcedureName" label="告知手续名称" align="center" width="280px">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="emp_address" label="详细地址" align="center"></el-table-column>
            <!--<el-table-column-->
            <!--show-overflow-tooltip-->
            <!--prop="weixin"-->
            <!--label="当前状态"-->
